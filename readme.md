- Mastering Systems with a Decentralized Mentality:
  - **Linux, VMware ESXI, NSX-T, Active Directory, Ansible, Kubernetes, Docker, Podman, OpenShift, Hyper-V, Windows Server, Proxmox, Prometheus, Zabbix, PostgreSQL, Security, Hardening, Networking, Storage, Azure, Office365**
